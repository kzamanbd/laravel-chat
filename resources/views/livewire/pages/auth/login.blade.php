...
new #[Layout('layouts.chat')] class extends Component {
...
<div class="bg-light dark:bg-dark-700 dark:text-gray-300">
        ...
        <div class="login-bg">
            ...
            <div class="rounded-md bg-white px-8 py-6 shadow-md">
                <div class="my-4 flex items-center justify-center space-x-2">
                    <p class="dark--text text-3xl font-semibold">
                        Reverb <span class="text-primary">App</span>
                    </p>
                </div>
                <div class="my-3">
                    <p class="dark--text mb-2 text-2xl font-semibold">Welcome to Reverb!</p>
                    <p class="text-xs text-gray-600">Please sign-in to your account and start the adventure</p>
                </div>

                <div class="my-4 space-y-4 lg:flex lg:items-center lg:space-x-4 lg:space-y-0">
                    <button
                        class="dark--text flex w-full items-center justify-center rounded-md border border-gray-200 bg-white p-2 text-sm hover:bg-gray-100 lg:w-1/2">
                ...
                <div class="flex items-center justify-between">
                    <span class="w-1/2 border-b dark:border-dark"></span>
                    <span class="mx-4 text-xs uppercase text-gray-500 dark:text-gray-400">or</span>
                    <span class="w-1/2 border-b dark:border-dark"></span>
                </div>
                ...
                <form class="my-3" wire:submit="login">
                    <label class="block">
                        ...
                        <input wire:model="form.email" type="email" name="email" class="form-input"
                    ...
                    <label class="my-2 block">
                        ...
                        <input wire:model="form.password" type="password" name="password" class="form-input"
                    ...
                    <div class="flex items-center justify-between">
                        <label class="inline-flex items-center">
                            <input wire:model="form.remember" type="checkbox" name="remember" class="form-checkbox" />
                            <span class="dark--text text-sm">Remember me</span>
                        </label>
                        @if (Route::has('password.request'))
                            <a class="block text-sm text-primary-600 hover:underline"
                ...
                <p class="dark--text">
                    ...
                    <a href="{{ route('register') }}" class="text-primary" wire:navigate>Sign up here</a>
                </p>
            </div>
        </div>
    </div>
