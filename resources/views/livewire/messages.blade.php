<div>
    <div x-data="chat">
        <div class="max-w-7xl mx-auto chat-wrapper overflow-hidden" :class="{ 'min-h-[999px]': chatMenu }">
            <div class="card chat-sidebar" :class="chatMenu && '!block'" x-data="{ currentTab: 'message' }">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-none">
                            <img src="/images/users/avatar-1.png" class="h-12 w-12 rounded-full object-cover" />
                        </div>
                        <div class="mx-3">
                        ...
                        <ul class="dropdown-menu right-0 w-48 whitespace-nowrap">
                            <li>
                                <a href="javascript:;" class="dropdown-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 mr-1 shrink-0">
                ...
                <div class="relative">
                    <input type="text" class="peer form-input pr-9" placeholder="Searching..." x-model="searchUser"
                        @keyup="searchUsers" />
                ...
                <div class="flex items-center justify-between text-xs">
                    <button type="button" class="group hover:text-primary" @click="currentTab = 'message'"
                        :class="{ 'text-primary': currentTab == 'message' }">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-1 h-5 w-5">
                            <path opacity="0.5"
                    ...
                    <button type="button" class="group hover:text-primary" @click="currentTab = 'calls'"
                        :class="{ 'text-primary': currentTab == 'calls' }">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-1 h-5 w-5">
                            <path
                    ...
                    <button type="button" class="group hover:text-primary" @click="currentTab = 'contacts'"
                        :class="{ 'text-primary': currentTab == 'contacts' }">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-1 h-5 w-5">
                    ...
                    <button type="button" class="group hover:text-primary" @click="currentTab = 'notification'"
                        :class="{ 'text-primary': currentTab == 'notification' }">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-1 h-5 w-5">
                            <path
                ...
                <div class="!mt-0">
                    <div x-show="currentTab == 'message'" data-simplebar class="chat-users my-2" wire:ignore>
                        <livewire:messages.conversation-list />
                    </div>
                    <div x-show="currentTab == 'contacts'" data-simplebar class="chat-users my-2">
                        @foreach ($this->users as $user)
                            <button type="button" class="chat-user-item">
                                <div class="flex-1">
                                    <div class="flex items-center">
            ...
            <div class="absolute z-[5] hidden h-full w-full rounded-md bg-black/60"
                :class="chatMenu && '!block xl:!hidden'" @click="chatMenu = !chatMenu"></div>
            <div class="card flex-1 p-0">
                @empty($conversation)
                    <div class="relative flex h-full items-center justify-center p-4">
                        <button type="button" class="absolute left-4 top-4 hover:text-primary xl:hidden"
                            @click="chatMenu = !chatMenu">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="flex flex-col items-center justify-center py-8">
                            ...
                            <p
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="mr-2 h-5 w-5">
                                    <path
                ...
                @if ($conversation)
                    <div class="relative h-full">
                        <div class="flex items-center justify-between p-4">
                            <div class="flex items-center space-x-2">
                                ...
                                <div class="relative flex-none">
                                    <img src="{{ $conversation->user_avatar }}"
                                ...
                                <div class="mx-3">
                                    ...
                                    <p class="text-white-dark text-xs">
                                        @if ($conversation->is_online)
                                            Active now
                                        @else
                                            Last seen at {{ $conversation->last_seen ?? 'N/A' }}
                                        @endif
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="h-px w-full border-b border-[#e0e6ed] dark:border-[#1b2e4b]"></div>
                        <div data-simplebar class="relative h-full overflow-auto sm:h-[calc(100vh_-_340px)]">
                                    ...
                                    <div class="flex items-start gap-3"
                                        ...
                                        <div class="flex-none"
                                            ...
                                            <template x-if="selectedUser.userId === message.fromUserId">
                                                <img :src="`/images/users/${loginUser.path}`"
                                                    class="h-10 w-10 rounded-full object-cover" />
                                            </template>
                                            <template x-if="selectedUser.userId !== message.fromUserId">
                                                <img :src="`/images/users/${selectedUser.path}`"
                                                    class="h-10 w-10 rounded-full object-cover" />
                                            </template>
                                        </div>
                                        <div class="space-y-2">
                                            <div class="flex items-center gap-3">
                                                <div class="rounded-md bg-black/10 p-4 py-2 dark:bg-gray-800"
                                                    :class="message.fromUserId == selectedUser.userId ?
                                                        'rounded-br-none  !bg-primary text-white' : 'rounded-bl-none'"
                                                ...
                                                <div :class="{ 'hidden': selectedUser.userId === message.fromUserId }">
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        ...
                                                        <ellipse cx="9" cy="10.5" rx="1"
                                                            ry="1.5" fill="currentColor"></ellipse>
                                                    </svg>
                                                </div>
                                            </div>
                                            <div class="text-white-dark text-xs"
                                                :class="{ 'text-right ': selectedUser.userId === message.fromUserId }"
    ...
    <x-slot name="scripts">
        <script src="{{ asset('ui/chat.js') }}"></script>
    </x-slot>
</div>
