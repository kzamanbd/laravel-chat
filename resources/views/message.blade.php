<x-chat-layout>
    <div x-data="chat">
        <div class="max-w-7xl mx-auto chat-wrapper overflow-hidden" :class="{ 'min-h-[999px]': isShowChatMenu }">
            <div class="card chat-sidebar" :class="isShowChatMenu && '!block'">
                ...
                <div class="!mt-0">
                    <div data-simplebar class="chat-users my-2">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center">
                                        <div class="relative flex-shrink-0">
                                            <img :src="`/images/users/${person.path}`"
                            ...
                            <div class="chat-empty-wrapper">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" class="h-full w-full"
                                    ...
                                    <path
                                        ...
                                        transform="translate(-154.35252 -77.40283)" fill="#e6e6e6"></path>
                                    <path
