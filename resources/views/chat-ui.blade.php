<x-b-layout>
    <div class="layout-wrapper d-lg-flex">
                            ...
                            <div id="tab-profile" class="accordion">
                                <div class="accordion-item card border mb-2">
                                    ...
                                    <div id="about" class="accordion-collapse collapse show"
                                        aria-labelledby="about2" data-bs-parent="#tab-profile">
                                ...
                                <div class="card accordion-item border">
                                    <div class="accordion-header" id="attach-file2">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#attach-file"
                                            aria-expanded="false" aria-controls="attach-file">
                                            <h5 class="font-size-14 m-0">
                                                <i
                                    ...
                                    <div id="attach-file" class="accordion-collapse collapse"
                                        aria-labelledby="attach-file2" data-bs-parent="#tab-profile">
                                        <div class="accordion-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-16 mb-0 text-truncate">
                                            <a href="#" class="text-reset user-profile-show">Doris Brown</a>
                                            <i
                                            ...
                                            <div class="ctext-wrap-content">
                                                <ul class="list-inline message-img mb-0">
                                                    <li class="list-inline-item message-img-list me-2 ms-0">
                                                        <div>
                                                            <a class="popup-img d-inline-block m-1"
                                                                href="{{ asset('chat-ui/images/small/img-1.jpg') }}"
                                                                title="Project 1">
                                                                <img src="{{ asset('chat-ui/images/small/img-1.jpg') }}"
                                                    ...
                                                    <li class="list-inline-item message-img-list">
                                                        <div>
                                                            <a class="popup-img d-inline-block m-1"
                                                                href="{{ asset('chat-ui/images/small/img-2.jpg') }}"
                                                                title="Project 2">
                                                                <img src="{{ asset('chat-ui/images/small/img-2.jpg') }}"
                                                                    class="rounded border" />
                                                            </a>
                                                        </div>
                                                        <div class="message-img-link">
        ...
        <!-- end modal -->
        <!-- add user modal -->
        <div id="add-user" role="dialog" class="modal fade" tabindex="-1"
