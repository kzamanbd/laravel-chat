            ...
            <div class="flex min-h-screen items-center justify-center p-6">
                <div class="login-bg">
                    ...
                    <div class="rounded-md bg-white px-8 py-6 shadow-md">
                        ...
                        <div
                            class="my-4 space-y-4 lg:flex lg:items-center lg:space-x-4 lg:space-y-0">
                            <button
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="mx-4 text-xs uppercase text-gray-500 dark:text-gray-400"
                                >or</span
                            >
                            <span class="w-1/2 border-b dark:border-dark"></span>
                        </div>
                        ...
                        <p class="dark--text">
                            ...
                            <Link :href="route('register')" class="text-primary">Sign up here</Link>
                        </p>
                    </div>
                </div>
            </div>
