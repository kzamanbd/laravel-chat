    ...
    <ChatLayout>
        <div class="chat-wrapper" :class="{ 'min-h-[999px]': chat.chatMenu }">
            ...
            <div class="card flex-1 p-0">
                <template v-if="!chat.chatUser">
                    <div class="relative flex h-full items-center justify-center p-4">
                        <button
                            type="button"
                            class="absolute left-4 top-4 hover:text-primary xl:hidden"
                        ...
                        <div class="flex flex-col items-center justify-center py-8">
                            ...
                            <p
                                class="bg-white-dark/20 mx-auto flex max-w-[190px] justify-center rounded-md p-2 font-semibold">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                ...
                <template v-if="chat.chatUser && selectedUser">
                    <div class="relative h-full">
                        <div class="flex items-center justify-between p-4">
                            <div class="flex items-center space-x-2">
                                ...
                                <div class="mx-3">
                                    <p class="font-semibold" v-html="selectedUser.name"></p>
                                    <p
                                ...
                                <template
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <template
                                                v-if="selectedUser.userId === message.fromUserId">
                                                <img
